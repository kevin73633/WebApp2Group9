            ...
            get(localuser, `users/${uid}`).then((snapshot) => {
              if (snapshot.exists()) {
                ...
                sessionStorage.setItem("allCourses",  JSON.stringify(global.allCourses));
                 ...
                 global.CreateNewCourse(new global.Course("SE301", "Advanced Programming & Design", "SE", "Y3S1", "APD is a major-core course for students majoring in Software Engineering (SE). Other SCIS (non-SE) students who are interested in a career as a software developer may take this course as a free elective. This course is offered only in term 1. Since APD is designed to be taken by year 3 or 4 students training to be software developers, a lot of self-study is expected. Students are expected to work on external resources (primarily videos and selected online courses) that will be provided as mandatory class preparatory work. Some of these external content - which may not be discussed in class - are examinable.", "1"));
                 // !!!!! 6CU Apprenticeship
